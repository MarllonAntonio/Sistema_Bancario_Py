...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
     ...
     if excedeu_saldo:
          print("\n@@@ O valor excedeu o saldo! @@@")
     elif excedeu_limite:
          print("\n@@@ O valor excedeu o limite! @@@")
     elif excedeu_saques:
          print("\n@@@ Você atingiu o numero maximo de saques de hoje! @@@")
     elif valor>0:
          saldo -= valor
...
def criar_usuario(usuarios):
    ...
    data_nascimento = input("Infome sua data de nacimento (dd-mm-aaaa):\n")
    endereco = input("Digite seu endereço (logradouro, nro - bairro - cidade/uf):\n")

    print(f"confirmando seus dados:\n{nome}\n{data_nascimento}\n{endereco}") 
